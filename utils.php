...
function get_nav_items($is_nav = true)
{
    ...
    if (!$is_nav) {
        $render .= "<li><a href='privacy-policy.php'>Privacy Policy</a></li>";
        return $render;
    }
    if (get_user()) {
    ...
    <footer class='contain-y container'>
        <section>
            <div>
                ...
                <a href='https://facebook.com/gwsc' target='_blank'>
                    ...
                    <a href='https://twitter.com/gwsc' target='_blank'>
                    ...
                    <a href='https://youtube.com/gwsc' target='_blank'>
                        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='2em' height='2em'>
